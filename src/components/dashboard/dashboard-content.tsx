    ...
    <div className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-10">
      ...
      <div className="mb-10 flex flex-col items-start gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
        <div>
          ...
          <h1 className="mt-3 inline-block font-heading text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            Assets
          </h1>
      ...
      {stats.topUnits.length > 0 && (
        <div className="mb-8 flex flex-wrap items-center gap-x-6 gap-y-2 rounded-lg border border-border bg-card px-4 py-3 shadow-soft">
      ...
      {filtered.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-border bg-card py-20">
          <p className="font-heading text-xl text-foreground">No assets yet</p>
          ...
          {filtered.map((asset) => {
            ...
            return (
              <Link
                ...
                className="group flex items-stretch overflow-hidden rounded-lg border border-border bg-card shadow-soft transition-all hover:shadow-hover hover:-translate-y-0.5"
              >
                {/* Category colored edge */}
                ...
                <div className="flex flex-1 flex-col gap-4 p-4 pl-5 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
                  <div className="flex items-center gap-4 min-w-0">
                    <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-md ${unit.tint} font-heading text-lg font-bold text-foreground`}>
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-sm text-muted-foreground">
                        ...
                        <Badge variant="outline" className={`${unit.tint} border-0 text-[10px] uppercase tracking-wider text-foreground`}>
                          {unit.label}
                        </Badge>
                        {asset.brokerLabel && (
                  ...
                  <div className="flex items-center gap-6 pl-16 sm:pl-0">
                    <div className="text-left sm:text-right">
                      <p className="font-heading text-3xl font-bold leading-none text-foreground tabular-nums">
...
function KpiTile({
  ...
  return (
    <div className="relative overflow-hidden rounded-lg border border-border bg-card p-6 shadow-soft">
      ...
      <p className="mt-3 font-heading text-4xl font-bold leading-none text-foreground tabular-nums sm:text-5xl">
        {value}
      </p>
    </div>
  );
